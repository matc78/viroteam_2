  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        path: AppRoutes.clubSettings,

        builder: (_, state) {

          final clubId = state.pathParameters['clubId']!;

          return ClubSettingsScreen(clubId: clubId);
      ...
      GoRoute(
        ...
        path: AppRoutes.clubLocations,

        builder: (_, state) {

          final clubId = state.pathParameters['clubId']!;

          return ClubLocationsScreen(clubId: clubId);
